...
// 
//     const double factor = 1.0 / 1e6;
//     auto trac_doubles = reinterpret_vector<double>(rhs.trac);
//     for (size_t i = 0; i < trac_doubles.size(); i++) 
//     {
//         trac_doubles[i] *= factor;
//     }
// 
//     auto new_disp_disp_matrix = lhs.disp_disp;
//     for (size_t i = 0; i < new_disp_disp_matrix.size(); i++) 
//     {
//         new_disp_disp_matrix[i] *= factor;
//     }
//     auto new_trac_disp_matrix = lhs.trac_disp;
//     for (size_t i = 0; i < new_trac_disp_matrix.size(); i++) 
//     {
//         new_trac_disp_matrix[i] *= factor;
//     }
//     LHSMatrices<dim> new_lhs = {new_disp_disp_matrix, new_trac_disp_matrix, lhs.disp_trac, lhs.trac_trac};
// 
...
//                 new_lhs.trac_trac, solver.kernels.hypersingular,
//                 disp_dofs, unknown_trac
//             );
//             auto eval_disp_trac = bem_mat_mult(
//                 new_lhs.disp_trac, solver.kernels.adjoint_traction,
...
//                 new_lhs.trac_disp, solver.kernels.traction,
//                 trac_dofs, unknown_trac
//             );
//             auto eval_disp_disp = bem_mat_mult(
//                 new_lhs.disp_disp, solver.kernels.displacement,
